...
instance Print Syntax.Exp.Abs.Exp where
  prt i = \case
    ...
    Syntax.Exp.Abs.ListHead exp -> prPrec i 11 (concatD [doc (showString "head"), prt 12 exp])
    Syntax.Exp.Abs.ListTail exp -> prPrec i 11 (concatD [doc (showString "tail"), prt 12 exp])
    Syntax.Exp.Abs.ListNull exp -> prPrec i 11 (concatD [doc (showString "null"), prt 12 exp])
    Syntax.Exp.Abs.ListLength exp -> prPrec i 11 (concatD [doc (showString "length"), prt 12 exp])
    Syntax.Exp.Abs.ListFold exp1 exp2 exp3 -> prPrec i 11 (concatD [doc (showString "foldl"), prt 12 exp1, prt 12 exp2, prt 12 exp3])
    Syntax.Exp.Abs.ListMap exp1 exp2 -> prPrec i 11 (concatD [doc (showString "map"), prt 12 exp1, prt 12 exp2])
    Syntax.Exp.Abs.ListElem exp1 exp2 -> prPrec i 11 (concatD [doc (showString "elem"), prt 12 exp1, prt 12 exp2])
    Syntax.Exp.Abs.ListTake exp1 exp2 -> prPrec i 11 (concatD [doc (showString "take"), prt 12 exp1, prt 12 exp2])
    Syntax.Exp.Abs.ListDrop exp1 exp2 -> prPrec i 11 (concatD [doc (showString "drop"), prt 12 exp1, prt 12 exp2])
