...
-- token TLApp
\⊙ | \( \* \)
    { tok (eitherResIdent T_TLApp) }

-- token TSub
\← | \< \-
    { tok (eitherResIdent T_TSub) }

-- token TMatch
\→ | \- \>
    { tok (eitherResIdent T_TMatch) }

-- token TSingle
𝟙 | \{ \* \}
    { tok (eitherResIdent T_TSingle) }
...
resWords =
  b "fst" 21
    (b "<" 11
       ...
       (b "boxI" 16
          (b "^" 14 (b ">" 13 (b "=" 12 N N) N) (b "box" 15 N N))
          (b "fix" 19
             (b "false" 18 (b "else" 17 N N) N) (b "force" 20 N N))))
    (b "out" 31
       (b "inR" 26
          (b "in:" 24 (b "in" 23 (b "if" 22 N N) N) (b "inL" 25 N N))
          (b "next" 29
             (b "match" 28 (b "let" 27 N N) N) (b "normal" 30 N N)))
       (b "then" 36
          (b "rand" 34 (b "prevI" 33 (b "prev" 32 N N) N) (b "snd" 35 N N))
          (b "{" 39 (b "unbox" 38 (b "true" 37 N N) N) (b "}" 40 N N))))
  where
  b s n = B bs (TS bs n)
    where
    bs = s
