...
-- token TForall
\∀ | \\ \- \/
    { tok (eitherResIdent T_TForall) }

-- token TLater
\▶ | \| \>
    { tok (eitherResIdent T_TLater) }

-- token TBox
\█ | \[ \]
    { tok (eitherResIdent T_TBox) }

-- token TMu
μ | \| u
    { tok (eitherResIdent T_TMu) }

-- token TRarrow
\→ | \- \>
    { tok (eitherResIdent T_TRarrow) }
...
resWords =
  b "." 4
    (b ")" 2 (b "(" 1 N N) (b "+" 3 N N))
    (b "real" 6 (b "bool" 5 N N) (b "x" 7 N N))
  where
  b s n = B bs (TS bs n)
    where
    bs = s
