...
BConst
  : 'true' { Syntax.Raw.Abs.BTrue }
  | 'false' { Syntax.Raw.Abs.BFalse }

Exp13 :: { Syntax.Raw.Abs.Exp }
Exp13
  : TSingle { Syntax.Raw.Abs.Single $1 }
...
Exp12
  : 'next' Exp13 { Syntax.Raw.Abs.Next $2 }
...
Exp11
  : Exp11 '|' Exp12 '|' { Syntax.Raw.Abs.ListIndex $1 $3 }
...
Exp10
  : Exp10 Exp11 { Syntax.Raw.Abs.App $1 $2 }
...
Exp9
  : '-' Exp10 { Syntax.Raw.Abs.Min $2 }
  | Exp9 '^' Exp10 { Syntax.Raw.Abs.Pow $1 $3 }
  | Exp10 { $1 }

Exp8 :: { Syntax.Raw.Abs.Exp }
Exp8
  : Exp8 '*' Exp9 { Syntax.Raw.Abs.Mul $1 $3 }
...
Exp7
  : Exp7 '+' Exp8 { Syntax.Raw.Abs.Add $1 $3 }
  | Exp7 '-' Exp8 { Syntax.Raw.Abs.Sub $1 $3 }
  | Exp8 { $1 }

Exp6 :: { Syntax.Raw.Abs.Exp }
Exp6
  : Exp6 '=' Exp7 { Syntax.Raw.Abs.Eq $1 $3 }
...
Exp4
  : Exp4 Conj Exp5 { Syntax.Raw.Abs.And $1 $2 $3 }
...
Exp2
  : 'if' Exp13 'then' Exp3 'else' Exp3 { Syntax.Raw.Abs.Ite $2 $4 $6 }
  | Exp3 { $1 }

Exp1 :: { Syntax.Raw.Abs.Exp }
Exp1
  : 'match' Exp13 '{' 'inL' Ident TMatch Exp2 ';' 'inR' Ident TMatch Exp2 '}' { Syntax.Raw.Abs.Match $2 $5 $6 $7 $10 $11 $12 }
  | Exp2 { $1 }

Exp :: { Syntax.Raw.Abs.Exp }
Exp
  : Lam Ident '.' Exp { Syntax.Raw.Abs.Abstr $1 $2 $4 }
...
Prg
  : 'let' Environment 'in:' Exp { Syntax.Raw.Abs.DefProg $2 $4 }
